...
function M.setup()
  ...
  -- Make CursorLine more subtle, keep foreground
  hl("CursorLine", { bg = "#252a2d" })
  hl("CursorLineNr", { fg = colors.editorLineNumber_activeForeground, bg = "#252a2d" })
  hl("LineNr", { fg = colors.editorLineNumber_foreground })
  -- Make Visual selection more subtle, and improve text legibility
  hl("Visual", { bg = "#2a3035", fg = colors.foreground })
    -- Make Search highlights more subtle
  ...
  -- Make MatchParen more subtle
  hl("MatchParen", {fg = colors.icon_foreground, bg = "#3a4045"})
 ...
 -- Telescope
  ...
  -- Improve TelescopeSelection legibility:  subtle background, clear foreground
  hl("TelescopeSelection", { fg = colors.foreground, bg = "#2a3035" })
