return {
	{
		...
		opts = {
			on_attach = function(bufnr, test)
				...
				-- Toggles
				map("n", "<leader>ghB", gitsigns.toggle_current_line_blame, { desc = "Toggle git show blame line" })
				map("n", "<leader>ghx", gitsigns.toggle_deleted, { desc = "Toggle git show Deleted" })
			end,
		},
	},
}
