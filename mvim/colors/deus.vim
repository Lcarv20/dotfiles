...
call s:HL('StatusLine',   s:bg2, s:fg2, s:bold . s:inverse)
call s:HL('StatusLineNC', s:bg2, s:fg2, s:bold . s:inverse)

" Whitespac
hi! link Whitespace deusBg1
