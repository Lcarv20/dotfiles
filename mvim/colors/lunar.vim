" Name:         Lunar
" Description:  Light and dark colorschemes (based on lunaperche)
" Author:       lcarv
" Maintainer:   lcarv
" License:      MIT
...
hi! link OilDirHidden Directory
if &background ==# 'dark'
  ...
  hi Normal guifg=#c6c6c6 guibg=#181818 gui=NONE cterm=NONE
  hi Statusline guifg=NONE guibg=#303030 gui=bold cterm=bold
  hi StatuslineNC guifg=#5fafff guibg=#181818 gui=NONE cterm=NONE
  hi VertSplit guifg=#f4f4ff guibg=NONE gui=NONE cterm=NONE
  hi TabLine guifg=#c6c6c6 guibg=#3a2c42 gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=#2b272e gui=NONE cterm=NONE
  hi TabLineSel guifg=#ffffff guibg=#6a4280 gui=bold cterm=bold
  ...
  hi NormalFloat guifg=NONE guibg=#181818 gui=NONE cterm=NONE
  ...
  hi Visual guifg=NONE guibg=#05374d gui=NONE cterm=NONE
  ...
  hi Directory guifg=#ff87ff guibg=NONE gui=bold cterm=bold
  ...
  hi Pmenu gNONENONENONENONENONENONEuifg=NONE guibg=#eeeeee gui=NONE cterm=NONE
  ...
  "hi NormalFloat guifg=NONE guibg=#c24332 gui=NONE cterm=NONE
  hi SignColumn guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  ...
  hi Visual guifg=NONE guibg=#cbe0f5 gui=NONE cterm=NONE
  hi MatchParen guifg=#ff00af guibg=NONE gui=bold cterm=bold
  ...
  hi Underlined guifg=NONE guibg=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
  hi Title guifg=NONE guibg=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
  hi Directory guifg=#af00af guibg=NONE gui=bold cterm=bold
